...
/**
 * shows the password by changing the input type to 'text'
 * and updating the icon to indicate visibility.
 *
 * @param {HTMLInputElement} input - the password input element to reveal.
 * @param {HTMLElement} iconContainer - the element containing the visibility icon.
 */
...
/**
 * hides the password by changing the input type to 'password'
 * and updating the icon to indicate concealment.
 *
 * @param {HTMLInputElement} input - the password input element to conceal.
 * @param {HTMLElement} iconContainer - the element containing the visibility icon.
 */
...
function getLockSVG() {
    return `
        <svg class="top-0" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none" viewBox="0 0 256 256">

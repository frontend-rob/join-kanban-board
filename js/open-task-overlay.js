...
async function editTask(taskId) {
    try {
        ...
        console.log('Priority Wert:', priority);

        const iconPath = `assets/icons/priority-${priority}.svg`;
        console.log('Icon-Pfad:', iconPath);
                            ...
                            <div class="input-group">
                                <div class="prio-group">
                                    ...
                                    <div class="prio-buttons">
                                        <button id="high-priority-button" 
                                                class="btn btn-urgent ${priority === 'high' ? 'clicked' : ''}" 
                                                type="button" 
                                                onclick="setPriority(this, 'high')">
                                            Urgent
                                        </button>
                                        <button id="mid-priority-button" 
                                                class="btn btn-medium ${priority === 'mid' ? 'clicked' : ''}" 
                                                type="button" 
                                                onclick="setPriority(this, 'mid')">
                                            Medium
                                        </button>
                                        <button id="low-priority-button" 
                                                class="btn btn-low ${priority === 'low' ? 'clicked' : ''}" 
                                                type="button" 
                                                onclick="setPriority(this, 'low')">
                                            Low
                                        </button>
                                    </div>
                                </div>
...
function setPriority(button, priority) {
    if (!button || !priority) return;

    const buttons = document.querySelectorAll('.prio-buttons .btn');

...
function getAddTaskContent() {
    return `
            <section class="add-task-content">
                ...
                <form id="add-task-form" class="add-task-form" onsubmit="addTask(event)">
                    <div class="left-column">
                        <div class="input-group">
                            <label for="task-title">Title<span class="required">*</span></label>
                            <div class="input-field">
                                <input type="text" id="task-title" class="required-input" placeholder="Enter a title">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-field">
                                <input type="text" id="assigned" placeholder="Select contacts to assign" readonly onclick="toggleContactDropdown()">
                                <div class="error-message-addtask"></div>
                                <svg id="contact-dropdown-icon" class="dropdown-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#000000"
                                    viewBox="0 0 256 256">
                    ...
                    <div class="divider-vertical divider-overlay"></div>

                    <div class="right-column">
                        <div class="input-group date-input">
                            <label for="due-date">Due date<span class="required">*</span></label>
                            <div class="input-field">
                                <input type="text" id="due-date" placeholder="yyyy-mm-dd">
                                <div class="error-message-addtask"></div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none" viewBox="0 0 256 256">
                                    <path
                        ...
                        <div class="input-group category-container">
                            ...
                            <div class="input-field">
                                <input type="text" id="task-category" placeholder="Select a category" onclick="toggleCategoryDropdown()">
                                <div class="error-message-addtask"></div>
                        ...
                        <div class="input-group addSubtask-container">
                            ...
                            <div class="input-field-subtask">
                                ...
                                <div id="addSubtask-icons" class="subtask-icons">
                                    ...
                                    <!-- Delete and Confirm Icons (Initially hidden) -->
                            ...
                            <!-- Subtask list placed outside the icons container to appear below the input field -->
